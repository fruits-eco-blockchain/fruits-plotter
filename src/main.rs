...
fn main() {
    let arg = App::new("Fruits Plotter")
        ...
        */
        ...
        .arg(
            ...
            Arg::with_name("low priority")
                .short("l")
                .long("prio")
                .help("Runs fruits-plotter with low priority")
                .global(true),
        ).arg(
            Arg::with_name("non-verbosity")
                .short("q")
                .long("quiet")
                .help("Runs fruits-plotter in non-verbose mode")
                .global(true),
        ).arg(
            Arg::with_name("benchmark")
                .short("b")
                .long("bench")
                .help("Runs fruits-plotter in xPU benchmark mode")
                .global(true),
        )
        /*
        .subcommand(
